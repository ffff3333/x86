...
#sed -i '1i src-git small https://github.com/ffff3333/small' feeds.conf.default
#sed -i '2i src-git kenzo https://github.com/kenzok8/openwrt-packages' feeds.conf.default
sed -i '3i src-git flrz https://github.com/flrz/openwrt-packages' feeds.conf.default
